...
function getActivityInLastNDays(dateStrings: string[], N: number): number {
  ...
  const count: number = dates.reduce(
    (acc, date) =>
      acc +
      (currentDateTime - date.getTime() <= 1000 * 60 * 60 * 24 * N ? 1 : 0),
    0
  );
  return count;
}
...
const addCreationCountsToUserList = (
  firstList: IUser[],
  secondList: ICreatedDatesDict[]
) => {
...
export default function UserListPage() {
  ...
  const [createdAtDict, setCreatedAtDict] = useState<
    ICreatedDatesDict[] | null
  >(null);
  ...
  useEffect(() => {
    if (sortedUserList) {
      const srtedUsrLst = [...sortedUserList].sort((a, b) => {
        if (
          typeof (a[sortField] ?? "0") === "string" &&
          typeof (b[sortField] ?? "0") === "string"
        ) {
          return sortBy === "asc"
            ? ((a[sortField ?? "createdAt"] as string) ?? "0").localeCompare(
                (b[sortField ?? "createdAt"] as string) ?? "0"
              )
            : ((b[sortField ?? "createdAt"] as string) ?? "0").localeCompare(
                (a[sortField ?? "createdAt"] as string) ?? "0"
              );
        } else if (
          typeof (a[sortField] ?? 0) === "number" &&
          typeof (b[sortField] ?? 0) === "number"
        ) {
          if (sortBy === "asc") {
            return (
  ...
  return sortedUserList ? (
    <div>
      ...
      <h3>
        Total active users: {aau} | MAU: {mau} | WAU: {wau} | DAU: {dau}
      </h3>

      <h3>
        <b>Lessons:</b> Total:{" "}
        {lessonCountDict?.allTime ? lessonCountDict.allTime : 0} | 28D:{" "}
        {lessonCountDict?.twentyeightDaysAgo
          ? lessonCountDict.twentyeightDaysAgo
          : 0}{" "}
        | 14D:{" "}
        {lessonCountDict?.forteenDaysAgo ? lessonCountDict.forteenDaysAgo : 0} |
      ...
      <h3>
        <b>videos:</b> Total:{" "}
        {videoCountDict?.allTime ? videoCountDict.allTime : 0} | 28D:{" "}
        {videoCountDict?.twentyeightDaysAgo
          ? videoCountDict.twentyeightDaysAgo
          : 0}{" "}
        | 14D:{" "}
        {videoCountDict?.forteenDaysAgo ? videoCountDict.forteenDaysAgo : 0} |
        ...
        <thead>
          ...
          <tr>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("auth0Id")}
                  sortingDirection={sortField === "auth0Id" ? sortBy : null}
                >
                  Email
                </Button>
              }
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("createdAt")}
                  sortingDirection={sortField === "createdAt" ? sortBy : null}
                >
                  Created At
                </Button>
              }
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("subscriptionDate")}
                  sortingDirection={
                    sortField === "subscriptionDate" ? sortBy : null
                  }
                >
                  Subscribed
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("totalCreated")}
                  sortingDirection={
                    sortField === "totalCreated" ? sortBy : null
                  }
                >
                  Tot. Lsns.
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("activityalldays")}
                  sortingDirection={
                    sortField === "activityalldays" ? sortBy : null
                  }
                >
                  All
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("activity28days")}
                  sortingDirection={
                    sortField === "activity28days" ? sortBy : null
                  }
                >
                  28D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("activity14days")}
                  sortingDirection={
                    sortField === "activity14days" ? sortBy : null
                  }
                >
                  14D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("activity7days")}
                  sortingDirection={
                    sortField === "activity7days" ? sortBy : null
                  }
                >
                  7D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("activity1days")}
                  sortingDirection={
                    sortField === "activity1days" ? sortBy : null
                  }
                >
                  1D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("createdalldays")}
                  sortingDirection={
                    sortField === "createdalldays" ? sortBy : null
                  }
                >
                  All
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("created28days")}
                  sortingDirection={
                    sortField === "created28days" ? sortBy : null
                  }
                >
                  28D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("created14days")}
                  sortingDirection={
                    sortField === "created14days" ? sortBy : null
                  }
                >
                  14D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("created7days")}
                  sortingDirection={
                    sortField === "created7days" ? sortBy : null
                  }
                >
                  7D
                </Button>
            ...
            <td>
              {
                <Button
                  onClick={() => sortActivity("created1days")}
                  sortingDirection={
                    sortField === "created1days" ? sortBy : null
                  }
                >
                  1D
                </Button>
                    ...
                    <a
                      href={
                        process.env.NEXT_PUBLIC_VERCEL_ENV == "development"
                          ? `http://localhost:3000/dashboard/${item.id}`
                          : `https://admin.astrosafe.co/dashboard/${item.id}`
                      }
                    >
                      Go to profile
                    </a>
