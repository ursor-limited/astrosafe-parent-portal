...
export default function PediaLandingPageSignedInView(props: {
  ...
  return (
    <Auth0Provider
      domain={process.env.NEXT_REACT_APP_AUTH0_DOMAIN as string}
      clientId={process.env.NEXT_REACT_APP_AUTH0_CLIENT_ID as string}
      authorizationParams={{
        audience: "https://api-gateway-authorizer",
        redirect_uri: process.env.NEXT_REACT_APP_AUTH0_REDIRECT_URL as string,
      }}
